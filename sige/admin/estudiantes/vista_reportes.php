                    ...
                    <div class="row mb-2">  
                        ...
                        <div class="col-sm-6">  
                            <ol class="breadcrumb float-sm-right">  
                                ...
                                <li class="breadcrumb-item"><a href="<?=APP_URL;?>/admin/inscripciones">Inscripciones</a></li>  
                ...
                <div class="col-md-12">  
                    <div class="card card-outline card-primary">  
                        <div class="card-body">  
                            ...
                            <a href="generar_reportes.php?id_gestion=<?= $gestion_activa['id_gestion']; ?>" class="btn btn-info">Generar Reporte de Matrícula Escolar</a>
                            </div>
