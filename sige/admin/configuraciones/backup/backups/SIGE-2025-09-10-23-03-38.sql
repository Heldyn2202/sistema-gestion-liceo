...
CREATE TABLE `carnets_emitidos` (
  `id_emision` int(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `carnets_emitidos_ibfk_1` FOREIGN KEY (`id_estudiante`) REFERENCES `estudiantes` (`id_estudiante`),
  CONSTRAINT `carnets_emitidos_ibfk_2` FOREIGN KEY (`id_diseno`) REFERENCES `diseno_carnets` (`id_diseno`)
...
CREATE TABLE `carnets_estudiantiles` (
  ...
  CONSTRAINT `carnets_estudiantiles_ibfk_1` FOREIGN KEY (`id_estudiante`) REFERENCES `estudiantes` (`id_estudiante`),
  CONSTRAINT `carnets_estudiantiles_ibfk_2` FOREIGN KEY (`id_plantilla`) REFERENCES `plantillas_carnet` (`id_plantilla`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `chat_conexiones` (
  ...
  CONSTRAINT `chat_conexiones_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `chat_mensajes` (
  ...
  CONSTRAINT `chat_mensajes_ibfk_1` FOREIGN KEY (`id_remitente`) REFERENCES `usuarios` (`id_usuario`),
  CONSTRAINT `chat_mensajes_ibfk_2` FOREIGN KEY (`id_destinatario`) REFERENCES `usuarios` (`id_usuario`)
) ENGINE=InnoDB AUTO_INCREMENT=82 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO chat_mensajes VALUES('70','1','75','Epale mi pana','','2025-09-04 21:35:44','1','1');
INSERT INTO chat_mensajes VALUES('71','1','75','fg','','2025-09-04 21:54:12','1','1');
INSERT INTO chat_mensajes VALUES('72','1','75','h','','2025-09-04 22:20:01','1','1');
INSERT INTO chat_mensajes VALUES('73','1','76','fgfgfg','','2025-09-04 22:20:08','0','1');
INSERT INTO chat_mensajes VALUES('74','1','75','fg','','2025-09-04 22:22:29','1','1');
INSERT INTO chat_mensajes VALUES('75','1','75','hola','','2025-09-04 22:22:57','1','1');
INSERT INTO chat_mensajes VALUES('76','1','75','df','','2025-09-04 22:23:24','1','1');
INSERT INTO chat_mensajes VALUES('77','1','75','fdf','','2025-09-04 22:23:52','1','1');
INSERT INTO chat_mensajes VALUES('78','1','75','','app/uploads/agustinzamora_20250904_222404_f2c6a5ef.jpg','2025-09-04 22:24:04','1','1');
INSERT INTO chat_mensajes VALUES('79','1','75','saf','','2025-09-04 23:16:28','1','1');
INSERT INTO chat_mensajes VALUES('80','1','75','dfdfdf','','2025-09-05 11:37:02','1','1');
INSERT INTO chat_mensajes VALUES('81','75','1','epalee','','2025-09-05 11:37:50','1','1');
...
INSERT INTO estudiantes VALUES('80','V','11200915','','0','Priscila','Cruz Mierez','2022-09-01','femenino','pc2202@gmail.com','Palo verde','04126271924','105','0','activo','2025-09-02 22:12:23','2025-09-02 22:12:23','ninguna','');
...
CREATE TABLE `horario_detalle` (
  ...
  CONSTRAINT `horario_detalle_ibfk_1` FOREIGN KEY (`id_horario`) REFERENCES `horarios` (`id_horario`),
  CONSTRAINT `horario_detalle_ibfk_2` FOREIGN KEY (`id_materia`) REFERENCES `materias` (`id_materia`),
  CONSTRAINT `horario_detalle_ibfk_3` FOREIGN KEY (`id_profesor`) REFERENCES `profesores` (`id_profesor`)
) ENGINE=InnoDB AUTO_INCREMENT=9 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

INSERT INTO horario_detalle VALUES('1','1','Lunes','07:50:00','08:30:00','3','1');
...
INSERT INTO horarios VALUES('1','1','19','45','Aula 101','2025-05-04','2025-06-04');
INSERT INTO horarios VALUES('2','1','19','45','Aula 101','2025-05-04','2025-06-04');
INSERT INTO horarios VALUES('3','1','19','45','Aula 101','2025-05-04','2025-06-04');
INSERT INTO horarios VALUES('4','1','19','45','Aula 101','2025-05-04','2025-06-04');
...
INSERT INTO materias VALUES('1','Matemáticas','26','Preescolar','1','','');
...
INSERT INTO notas_estudiantes VALUES('1','1','1','1','18.00','','2025-04-15 02:20:07');
...
INSERT INTO notas_estudiantes VALUES('17','1','1','3','16.00','','2025-05-11 18:21:28');
...
INSERT INTO permisos VALUES('14','Cargar Notas','admin/cargar_notas.php','2025-08-18 00:04:40','','1');
INSERT INTO permisos VALUES('15','Ver Notas','admin/ver_notas.php','2025-08-18 00:04:40','','1');
INSERT INTO permisos VALUES('16','Gestionar Horarios','admin/gestionar_horarios.php','2025-08-18 00:04:40','','1');
INSERT INTO permisos VALUES('17','f','f','2025-09-06 00:00:00','','1');
...
CREATE TABLE `preguntas_seguridad` (
  ...
  KEY `usuario_id` (`usuario_id`),
  CONSTRAINT `preguntas_seguridad_ibfk_1` FOREIGN KEY (`usuario_id`) REFERENCES `usuarios` (`id_usuario`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO profesores VALUES('1','v12345678','Juan','Pérez','juan.perez@example.com','11987654321','Matemáticas','1','2025-05-13 14:15:38','2025-06-12 19:36:22','1','e10adc3949ba59abbe56e057f20f883e');
...
INSERT INTO representantes VALUES('3','V','13023562','Luis Fernando','Martínez Ruiz','1990-07-20','Soltero','','masculino','luisfernando@gmail.com','B+','Caracas','04121234502','Activo','2025-01-24 07:59:04');
...
INSERT INTO roles VALUES('1','ADMINISTRADOR','2024-10-26 19:22:07','2025-08-17 23:58:15','1');
...
CREATE TABLE `roles_permisos` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `rol_id` (`rol_id`,`permiso_id`),
...
INSERT INTO roles_permisos VALUES('1','1','1','1');
INSERT INTO roles_permisos VALUES('2','1','2','1');
INSERT INTO roles_permisos VALUES('3','1','3','1');
INSERT INTO roles_permisos VALUES('4','1','4','1');
INSERT INTO roles_permisos VALUES('5','1','5','1');
INSERT INTO roles_permisos VALUES('6','1','6','1');
INSERT INTO roles_permisos VALUES('7','1','7','1');
INSERT INTO roles_permisos VALUES('8','1','8','1');
INSERT INTO roles_permisos VALUES('9','1','9','1');
INSERT INTO roles_permisos VALUES('10','1','10','1');
INSERT INTO roles_permisos VALUES('11','1','11','1');
INSERT INTO roles_permisos VALUES('12','1','12','1');
INSERT INTO roles_permisos VALUES('13','1','13','1');
INSERT INTO roles_permisos VALUES('14','1','14','1');
INSERT INTO roles_permisos VALUES('15','1','15','1');
INSERT INTO roles_permisos VALUES('16','1','16','1');
INSERT INTO roles_permisos VALUES('32','5','14','1');
INSERT INTO roles_permisos VALUES('33','5','15','1');
INSERT INTO roles_permisos VALUES('34','5','16','1');
...
INSERT INTO usuarios VALUES('75','5','heldyndiaz19@gmail.com','$2y$10$FmaQCuz3RujZzOKEMX4DpeiVqOM3fuK.a3y1f9hA.vx8WBoij4bbS','2025-08-18 00:00:00','','1','','');
INSERT INTO usuarios VALUES('76','5','david@gmail.com','$2y$10$j5IsFGsSl0almiAeITSi2eBMeJgbOKMvJOYaKcx0GuLI7DgphWrzS','2025-09-03 00:00:00','2025-09-08 00:00:00','1','','');
